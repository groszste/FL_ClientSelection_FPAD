...
num_oulu_clients_print = 5
num_oulu_clients_replay = 5
...
#load data files
data_dir = 'exp3_oulu_print_at_server' #(exp3_siwm_replay_at_server, exp3_siwm_print_at_server, exp3_oulu_replay_at_server, exp3_oulu_print_at_server)
classes = {'Live': 0, 'PA': 1}
server_model_path = data_dir + '/results/server/round_3'
...
if (cs_algorithm == 'FedAvg'):
	...
	for comm_round in range(comms_round):
		...
		print('siwm print: comm_round: {} | global_acc: {:.3%} | global_loss: {}'.format(comm_round, acc_siwm_print, loss_siwm_print))
		...
		print('siwm replay: comm_round: {} | global_acc: {:.3%} | global_loss: {}'.format(comm_round, acc_siwm_replay, loss_siwm_replay))
		...
		print('oulu print: comm_round: {} | global_acc: {:.3%} | global_loss: {}'.format(comm_round, acc_oulu_print, loss_oulu_print))
		...
		print('oulu replay: comm_round: {} | global_acc: {:.3%} | global_loss: {}'.format(comm_round, acc_oulu_replay, loss_oulu_replay))

		global_model.save(data_dir + '/results/' + cs_algorithm + '/round_' + str(comm_round))

		with open(data_dir + '/results/' + cs_algorithm + '/results.txt', 'w') as f:
			f.write('ROUND ' + str(comm_round) + ': SIWM_Print_Acc={:.4} SIWM_Replay_Acc={:.4} OULU_Print_Acc={:.4} OULU_Replay_Acc={:.4} \
				SIWM_Print_Loss={:.4} SIWM_Replay_Loss={:.4} OULU_Print_Loss={:.4} OULU_Replay_Loss={:.4} WD={:.4} '.\
				format(acc_siwm_print, acc_siwm_replay, acc_oulu_print, acc_oulu_replay, \
					loss_siwm_print, loss_siwm_replay, loss_oulu_print, loss_oulu_replay, np.mean(wd)) + 'Clients=' + ','.join(client_names) + '\n')
	...
	for comm_round in range(comms_round):
		...
		with open(data_dir + '/results/' + cs_algorithm + '/results.txt', 'w') as f:
			f.write('ROUND ' + str(comm_round) + ': SIWM_Print_Acc={:.4} SIWM_Replay_Acc={:.4} OULU_Print_Acc={:.4} OULU_Replay_Acc={:.4} \
				SIWM_Print_Loss={:.4} SIWM_Replay_Loss={:.4} OULU_Print_Loss={:.4} OULU_Replay_Loss={:.4} WD={:.4} '.\
				format(acc_siwm_print, acc_siwm_replay, acc_oulu_print, acc_oulu_replay, \
					loss_siwm_print, loss_siwm_replay, loss_oulu_print, loss_oulu_replay, np.mean(clients_weight_divergence)) + \
